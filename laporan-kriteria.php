            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="text-align: left;">Bobot</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                // Query untuk mengambil data dari tabel
                $query = mysqli_query($koneksi, "SELECT nama_kriteria, bobot FROM data_kriteria");

                // Loop untuk menampilkan data
                while ($data = mysqli_fetch_assoc($query)) {
                    echo "<tr>
                            <td style='text-align: left;'>{$data['nama_kriteria']}</td>
                            <td style='text-align: left;'>{$data['bobot']}</td>
                          </tr>";
                }
                ?>
                </tbody>
